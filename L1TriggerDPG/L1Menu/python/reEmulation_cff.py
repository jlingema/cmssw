...
def reEmulation(process, reEmulMuons=True, reEmulCalos=True, patchNtuple=True, runOnPostLS1 = False):
    ...
    process.l1ExtraReEmulDPG = cms.EDProducer(
    ...
    if reEmulMuons :
        ...
        process.l1ExtraReEmulDPG.muonSource = cms.InputTag("gmtReEmulDigis")            
        ...
        if patchNtuple :
            ...
            l1ExtraNtuple.muonLabel = cms.untracked.InputTag("l1ExtraReEmulDPG")
    ...
    if reEmulCalos :
        ...
        process.l1ExtraReEmulDPG.isolatedEmSource    = cms.InputTag("gctReEmulDigis","isoEm")
        process.l1ExtraReEmulDPG.nonIsolatedEmSource = cms.InputTag("gctReEmulDigis","nonIsoEm")

        process.l1ExtraReEmulDPG.forwardJetSource = cms.InputTag("gctReEmulDigis","forJets")
        process.l1ExtraReEmulDPG.centralJetSource = cms.InputTag("gctReEmulDigis","cenJets")
        process.l1ExtraReEmulDPG.tauJetSource     = cms.InputTag("gctReEmulDigis","tauJets")
            
        process.l1ExtraReEmulDPG.etTotalSource = cms.InputTag("gctDigis")
        process.l1ExtraReEmulDPG.etHadSource   = cms.InputTag("gctReEmulDigis")
        process.l1ExtraReEmulDPG.etMissSource  = cms.InputTag("gctReEmulDigis")
        process.l1ExtraReEmulDPG.htMissSource  = cms.InputTag("gctReEmulDigis")

        process.l1ExtraReEmulDPG.hfRingEtSumsSource    = cms.InputTag("gctReEmulDigis")
        process.l1ExtraReEmulDPG.hfRingBitCountsSource = cms.InputTag("gctReEmulDigis")
    ...
    if reEmulMuons and reEmulCalos :
        process.reEmul = cms.Sequence(process.reEmulCaloChain + process.reEmulMuonChain + process.gtReEmulDigis + process.l1ExtraReEmulDPG)
    elif reEmulMuons :
        process.reEmul = cms.Sequence(process.reEmulMuonChain + process.gtReEmulDigis + process.l1ExtraReEmulDPG)
    elif reEmulCalos :
        process.reEmul = cms.Sequence(process.reEmulCaloChain + process.gtReEmulDigis + process.l1ExtraReEmulDPG)
    else :
        process.reEmul = cms.Sequence(process.gtReEmulDigis + process.l1ExtraReEmulDPG)
